...
export class InitialMigration1694621564745 implements MigrationInterface {
    name = 'InitialMigration1694621564745'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "schedules" ("id" SERIAL NOT NULL, "date" date NOT NULL DEFAULT now(), "hour" character varying NOT NULL, "realEstateId" integer NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_7e33fc2ea755a5765e3564e66dd" PRIMARY KEY ("id"))`);
